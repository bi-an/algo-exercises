...
#define __cpp_lib_shared_ptr_weak_type 201606
   ...
   private:
    ...
    shared_ptr(_Sp_make_shared_tag __tag, const _Alloc &__a, _Args &&... __args) : __shared_ptr<_Tp>(__tag, __a, std::forward<_Args>(__args)...)
    {
    }
...
#define __cpp_lib_enable_shared_from_this 201603
   ...
   private:
    ...
    friend const enable_shared_from_this *__enable_shared_from_this_base(const __shared_count<> &, const enable_shared_from_this *__p)
    {
      return __p;
    }
