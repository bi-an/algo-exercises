...
static TreeLinkNode* ConstructLinkTreeCore(std::vector<int>& pre, int startPre, int endPre,
	std::vector<int>& vin, int startVin, int endVin);
...
static TreeLinkNode* ConstructLinkTreeCore(
	std::vector<int>& pre, int startPre, int endPre,
	std::vector<int>& vin, int startVin, int endVin
) 
{
	// TODO
	if (startPre > endPre || startVin > endVin || endPre - startPre != endVin - startVin) return nullptr;
